...
class ClientesController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AppBundle\Form\ClienteType', $clientes);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('cliente_show', array('id' => $clientes->getId()));
        }
     ...
     * @Method("GET")
     */
    public function showAction(Carrera $cliente)
    {
     ...
     * @Method("DELETE")
     */
    public function deleteAction(Request $request, Carrera $cliente)
    {
     ...
     *
     * @param Carrera $cliente The cliente entity
     *
    ...
    private function createDeleteForm(Cliente $cliente)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('carrera_delete', array('id' => $cliente->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
